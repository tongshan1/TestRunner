...
Revision ID: e1432ac78017
Revises: 
Create Date: 2018-04-28 17:01:04.821862
...
def upgrade():
    ...
    op.create_index(op.f('ix_Interface_datachange_lasttime'), 'Interface', ['datachange_lasttime'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_Interface_datachange_lasttime'), table_name='Interface')
